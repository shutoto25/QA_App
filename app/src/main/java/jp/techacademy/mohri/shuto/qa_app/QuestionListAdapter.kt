...
class QuestionListAdapter(context: Context) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val titleText = convertView!!.findViewById<View>(R.id.tvQuestionTitle) as TextView
        titleText.text = mQuestionArrayList[position].title

        val nameText = convertView.findViewById<View>(R.id.tvName) as TextView
        nameText.text = mQuestionArrayList[position].name

        val resText = convertView.findViewById<View>(R.id.tvImageView) as TextView
        ...
        if (bytes.isNotEmpty()) {
            ...
            val imageView = convertView.findViewById<View>(R.id.ivImageView) as ImageView
